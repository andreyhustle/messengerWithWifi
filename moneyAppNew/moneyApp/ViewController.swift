...
//  ThrowableMoney
//
//  Created by Anton Salii on 09.09.2017.
//  Copyright © 2017 Anton Salii. All rights reserved.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.treeNode = scene.rootNode.childNode(withName: "ball_1", recursively: true)
